...
public class ConfSQL {    
    ...
    public static final String INSERT_MARKETS   = "INSERT INTO markets(region_id, market_id_on_region, market_name, comment) VALUES (?, ?, ?, ?);";    
    public static final String INSERT_TERMINALS = "INSERT INTO terminals(terminal_id_on_market, market_id, region_id, comment) VALUES (?, ?, ?, ?);";
